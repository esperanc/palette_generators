export {render, render_okhsl, render_static, oklab_C_scale };
import {hsluv} from "./hsluv.js";
import {rgb_to_hsl, hsl_to_rgb, rgb_to_hsv, hsv_to_rgb, srgb_transfer_function, srgb_transfer_function_inv, 
        linear_srgb_to_oklab, oklab_to_linear_srgb, toe_inv, okhsv_to_srgb, srgb_to_okhsv,
        find_gamut_intersection, srgb_to_okhsl, okhsl_to_srgb } from "./colorconversion.js";

const picker_size = 257;
const picker_size_inv = 1./picker_size;
const lowres_picker_size = (picker_size+1)/2;
...
{
    const hsl = hsluv.rgbToHsluv([r/255,g/255,b/255]);
    hsl[0] /= 360;
    hsl[1] /= 100;
    hsl[2] /= 100;
    return hsl;
...
function render(r,g,b)
{
...

    {
        ...
        const l = Math.sqrt(lab[1]*lab[1] +lab[2]*lab[2]);
        let a_ = lab[1]/l;
        let b_ = lab[2]/l;

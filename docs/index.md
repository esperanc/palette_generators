...
# Interactive palette generators

Here you will find several ways in which a color palette can be built interactively. 
Designed by Tuan Anh Nguyen Phuc.
...
<div class="hero">
  <h1>Palette Generators</h1>
  <h2>Here you will find some interactive palette generators.</h2>
</div>
